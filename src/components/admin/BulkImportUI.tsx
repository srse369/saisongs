          ...
          <div className="space-y-4">
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md p-4">
              ...
              <ol className="text-sm text-blue-800 dark:text-blue-400 space-y-2 list-decimal list-inside">
                <li>Open <a href={`${import.meta.env.VITE_EXTERNAL_SOURCE_URL || 'http://localhost'}/songs`} target="_blank" rel="noopener noreferrer" >{import.meta.env.VITE_EXTERNAL_SOURCE_URL || 'http://localhost'}/songs</a> in a new tab</li>
        ...
        {hasError && importState.criticalError && (
          <div className="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md">
            <div className="flex items-start">
              <i className="fas fa-times-circle text-lg text-red-600 dark:text-red-400 mt-0.5 mr-3 flex-shrink-0"></i>
              <div>
          ...
          <div className="space-y-4">
            ...
            {isCompleted && (
              <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-md">
                <div className="flex items-start">
                  <i className="fas fa-check-circle text-lg text-green-600 dark:text-green-400 mt-0.5 mr-3 flex-shrink-0"></i>
                  <div>
            ...
            {hasErrors && (
              <div className="border border-gray-200 dark:border-gray-700 rounded-md overflow-hidden">
                ...
                >
                  ...
                  <i className={`fas fa-chevron-down text-lg text-gray-600 dark:text-gray-400 transition-transform ${
